...
<body>
    ...
    <script>
        ...
        function renderWorkers(
            ...
            workersTitle.className =
                "workers-title";

            workersTitle.textContent =
                "Workers Executados";


            workersSection.appendChild(
                workersTitle
            );
        ...
        function getWorkerDisplayStatus(
            worker
        ) {
        ...
        function buildLifecycleText(
            ...
            /*
                O snapshot atual do Brother é capturado
                antes do destroy().

                O runtime real executa DESTROY depois,
                comprovado pelo log do Kernel.

                Por isso a interface representa o ciclo
                operacional completo do Worker temporário.
            */

            if (
                worker.metadata
                &&
                worker.metadata.temporary
                === true
            ) {
                stages.push(
                    "DESTROY"
