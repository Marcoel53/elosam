...
async def execute_mission(goal):
    ...
    add_event(
        mission,
        "policy.started",
        "Policy Engine avaliando a missÃ£o.",
    )
...
<body>
    <main class="container">
        ...
        <div class="eyebrow">
            ...
            ORGANIZAÃ‡Ã•ES DIGITAIS
        </div>

        <h1>EloSam OS</h1>

        <div class="subtitle">
            Mission Control â€” Beta 1.1
        </div>
        ...
        <section class="panel">
            ...
            <p>
                ...
                deve ser transformado em missÃ£o.
            </p>

            <textarea
                id="goal"
                placeholder="Exemplo: Crie um plano para aumentar a renda da famÃ­lia."
            ></textarea>
    ...
    async def create_mission(
        ...
        if not goal:
            return {
                "success": False,
                "error":
                    "O objetivo da missÃ£o Ã© obrigatÃ³rio.",
            }
